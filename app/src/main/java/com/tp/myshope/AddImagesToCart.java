...
public class AddImagesToCart extends AppCompatActivity {
    ...
    public void addtocart(View v) {
        ...
        alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                Product p = new Product(ImageFragment.ptitlei, ImageFragment.pimagei, ImageFragment.ppricei, ImageFragment.pdescriptioni,ImageFragment.plongdescriptioni);
                ProductBase data = new ProductBase(AddImagesToCart.this);
                try {
                    data.open();
                ...
                data.addImage(p);
                Toast.makeText(AddImagesToCart.this, "Added :" + " " + p.getProductName() + " to Cart", Toast.LENGTH_LONG).show();
                Intent intent = new Intent();
                setResult(RESULT_OK, intent);
                AddImagesToCart.super.onBackPressed();
            }
        });
