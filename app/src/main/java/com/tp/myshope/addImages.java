        ...
        }else if(e1.getText().equals(null)||e2.getText().equals(null)||e3.getText().equals(null))
        {
            ...
            alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    ImageFragment.image_detailsi.add(dvd);
                    ImageFragment.myadapteri = new ProductAdapter(addImages.this, ImageFragment.image_detailsi) ;
                    ImageFragment.listViewi.setAdapter(ImageFragment.myadapteri);

                    Intent intent = new Intent();
                    setResult(RESULT_OK, intent);
                    addImages.super.onBackPressed();
